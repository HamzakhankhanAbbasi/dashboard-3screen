...
?>
  ...
  <aside class="right-side">
    ...
    <section class="content-header">
      <h1 class="mt-30 pr-20"> Time Adjust Request</h1>
      <ol class="breadcrumb">
...
<div class="manage-screewrap">
            ...
            <div class="table-responsive table-rad">
               ...
               <table class="table table-dash table-hover">
                  <thead class="table-header">
                     <tr>
                        <th scope="col" class="head-3 annual-content text-2" colspan="2">Annual Leaves<span class="annual-days">14</span></th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td scope="row" class="taken-text pt-15">Taken  0</td>
                        <td class="taken-text pt-15">Balance  14.0</td>
                     </tr>
                  </tbody>
               </table>
               <!--table-end-->
         ...
         <div class="table-content">
            <div class="table-responsive table-rad">
               ...
               <table class="table table-dash table-hover">
                  <thead class="table-header">
                     <tr>
                        <th scope="col" class="head-3 annual-content text-2" colspan="2">Casual Leaves<span class="annual-days">10</span></th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td scope="row" class="taken-text pt-15">Taken  0</td>
                        <td class="taken-text pt-15">Balance  8.0</td>
                     </tr>
                  </tbody>
               </table>
               <!--table-end-->
         ...
         <div class="table-content">
            <div class="table-responsive table-rad">
               ...
               <table class="table table-dash table-hover">
                  <thead class="table-header">
                     <tr>
                        <th scope="col" class="head-3 annual-content text-2" colspan="2">Sick Leaves<span class="annual-days">8</span></th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
         ...
         <div class="table-content">
            <div class="table-responsive table-rad">
               ...
               <table class="table table-dash table-hover">
                  <thead class="table-header">
                     <tr>
                        <th scope="col" class="head-3 annual-content text-2" colspan="2">Probationary Leaves<span class="annual-days">0</span></th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td scope="row" class="taken-text pt-15">Taken  0</td>
                        <td class="taken-text pt-15">Balance  0</td>
                     </tr>
                  </tbody>
               </table>
               <!--table-end-->
         ...
         <div class="table-content">
            <div class="table-responsive table-rad">
               ...
               <table class="table table-dash table-hover">
                  <thead class="table-header">
                     <tr>
                        <th scope="col" class="head-3 annual-content total-color text-2" colspan="2">Total Leaves<span class="annual-days">32</span></th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td scope="row" class="text-total pt-15">Taken  2</td>
                        <td class="text-total pt-15">Balance  30</td>
                     </tr>
                  </tbody>
               </table>
               <!--table-end-->
   ...
   <div class="row">
               ...
               <table class="table table-dash table-hover">
                  <thead class="table-header">
                     <tr>
                        ...
                        <th scope="col" class="text-2 text-basic">Balance Salary without Deduction</th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td scope="row" class="text-1 pt-15">PKR 00,000</td>
                        <td class="head-left text-1">PKR 2,533 <span class="day-timing">(1.5 Days)</span></td>
                        <td class="head-left text-1">PKR 00.000</td>
                     </tr>
                  </tbody>
               </table>
               <!--table-end-->
      ...
      <div class="col-12 col-md-6 col-lg-6">
         <div class="table-content">
            <p class="table-content-1">Adjustment Criteris</p>
            <div class="table-responsive table-rad">
               <!--table-start-->
               <table class="table table-dash table-hover">
                  <thead class="table-header">
                ...
                <div class="adjustment-approval">
                    <div class="leave-manage-wrap">
                        ...
                        <div class="leave-1">
                             ...
                             <div class="radio-text-wrap">
                                <p class="radio-text-1 approval-text">
                                   Disapprove <span class="remark-mandatory">(Remarks Mendatory)</span>
                                </p>
                             </div>
                        </div>
                        <div class="leave-1">
                             ...
                             <div class="radio-text-wrap">
                                <p class="radio-text-1 approval-text">
                                   Revert <span class="remark-mandatory">(Remarks Mendatory)</span>
                                </p>
                             </div>
                        </div>
         ...
         <div class="col-12 col-md-3 col-lg-3 p-0">
            <div class="leave-wrap">
               <div class="radio-wrap">
                  <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-1">
                  <div class="radio-text-wrap">
                     <p class="radio-text-1" for="radio-1">
                        Leave Adjust
                     </p>
                  </div>
               </div>
               <div class="leaves-detail-1">
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-3">
                     <div class="radio-text-wrap">
                  ...
                  <div class="evidence-main-wrap">
                     <div class="row">
                        <div class="col-12 col-md-3 col-lg-3">
                           <p class="evidence-text mtt-10">Evidence : </p>
                           <img src="css/images/evid-1.png" class="img-fluid evi-img1  mt-5">
                        </div>
                        <div class="col-12 col-md-9 col-lg-9">
                           <!--choose-file-start-->
                           <div class="textarea-wrap mtt-10">
                              <p class="remarks-text">Remarks:</p>
                              <textarea class="textarea-evi"></textarea>
                           </div>
                           <!--choose-file-end-->
                        </div>
                     </div>
      ...
      <div class="row">
         ...
         <div class="col-12 col-md-3 col-lg-3 p-0">
            <div class="leave-wrap">
               ...
               <div class="leaves-detail-1">
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-77">
                     <div class="radio-text-wrap">
                        <p class="radio-text-1">
                           Annual Leave
                        </p>
                  ...
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-78">
                     <div class="radio-text-wrap">
                        <p class="radio-text-1" for="radio-78">
                           Sick Leave
                        </p>
                     </div>
                  </div>
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-79">
                     <div class="radio-text-wrap">
                        <p class="radio-text-1" for="radio-79">
                           Casual Leave
                        </p>
                     </div>
                  </div>
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-80">
                     <div class="radio-text-wrap">
                        <p class="radio-text-1" for="radio-80">
                           Probationary Leave
                        </p>
                     </div>
                  </div>
               ...
               <div class="radio-wrap">
                  <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-2">
                  <div class="radio-text-wrap">
                     <p class="radio-text-1 mb-2" for="radio-2">
                        Waive Off
                     </p>
                  </div>
               </div>
               ...
               <div class="reason-wrap">
                  ...
                  <div class="evidence-main-wrap">
                     <div class="row">
                        <div class="col-12 col-md-3 col-lg-3">
                           <p class="evidence-text mtt-10">Evidence : </p>
                           <img src="css/images/evid-2.png" class="img-fluid evi-img1  mt-5">
                        </div>
                        <div class="col-12 col-md-9 col-lg-9">
                           <!--choose-file-start-->
                           <div class="textarea-wrap mtt-10">
      ...
      <div class="row">
         ...
         <div class="col-12 col-md-3 col-lg-3 p-0">
            <div class="leave-wrap">
               ...
               <div class="leaves-detail-1">
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-70">
                     <div class="radio-text-wrap">
                        <p class="radio-text-1">
                           Annual Leave
                        </p>
                  ...
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-71">
                     <div class="radio-text-wrap">
                        <p class="radio-text-1" for="radio-71">
                           Sick Leave
                        </p>
                     </div>
                  </div>
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-72">
                     <div class="radio-text-wrap">
                        <p class="radio-text-1" for="radio-72">
                           Casual Leave
                        </p>
                     </div>
                  </div>
                  <div class="leave-1">
                     <input class="form-check-input radio-input" type="radio" name="flexRadioDefault" id="radio-73">
                     <div class="radio-text-wrap">
                        <p class="radio-text-1" for="radio-73">
                           Probationary Leave
                        </p>
                     </div>
                  </div>
               ...
               <div class="reason-wrap">
                  ...
                  <div class="evidence-main-wrap">
                     <div class="row">
                        <div class="col-12 col-md-3 col-lg-3">
                           <p class="evidence-text mtt-10">Evidence : </p>
                           <img src=""   onerror="this.onerror=null; this.src='css/images/no-evi.png'" alt=""  class="img-fluid evi-img1 mt-5">
                        </div>
                        <div class="col-12 col-md-9 col-lg-9">
                           <!--choose-file-start-->
                           <div class="textarea-wrap mtt-10">
